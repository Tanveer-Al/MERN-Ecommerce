...
const Cart = () => {
  ...
  const totalQty = data.reduce(
    (prevlousValue, currentValue) => prevlousValue + currentValue.quantity,
    0
  );
        ...
        <div className="mt-5 lg:mt-0 w-full max-w-sm">
          {loading ? (
            ...
            <div className="h-36 bg-white mt-3">
              <div className="text-white bg-red-600 px-4 py-1 flex items-center justify-center">Summary</div>
              ...
              <div className="flex items-center justify-between px-4 gap-2 font-medium text-lg text-slate-600">
                ...
                <p className="">{displayINRCurrency(totalPrice)}</p>
              </div>
              <button className="bg-blue-600 p-3 text-white w-full mt-2">Payment</button>
            </div>
          )}
        </div>
      </div>
